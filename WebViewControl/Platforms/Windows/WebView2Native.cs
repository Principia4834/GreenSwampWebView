...
internal static class WebView2Native
{
    ...
    // User32.dll imports for window management
    ...
    // WebView2Loader.dll imports
    [DllImport(WebView2LoaderDll, CallingConvention = CallingConvention.StdCall, PreserveSig = false)]
    public static extern void CreateCoreWebView2EnvironmentWithOptions(
        ...
        [MarshalAs(UnmanagedType.Interface)] ICreateCoreWebView2EnvironmentCompletedHandler completedHandler);
